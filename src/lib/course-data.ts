...
export const LESSONS: Lesson[] = [
  {
    ...
    duration: 22, xp: 50,
    task: 'Напишите одно предложение: за чем вы пришли на курс?',
    fact: 'Слово «коучинг» — из венгерского "kocsi szekér" — повозка из города Кочи. Дословно — то, что довозит до цели.',
    factTag: 'Этимология',
    pre: 'До следующего урока: вспомните три ситуации, где вы замечали, как мозг подсказывает решение.',
  ...
  },
  {
    ...
    duration: 17, xp: 60,
    task: 'Назовите один навык, который вы освоили за последний год. Что в мозге могло поменяться?',
  ...
  },
  {
    ...
    lecturer: 'Александра Болдина',
    duration: 43, xp: 50,
    task: 'Какой вопрос коуча показался самым сильным? Напишите его дословно.',
  ...
  },
  {
    ...
    lecturer: 'Александра Болдина',
    duration: 26, xp: 70,
    task: 'Опишите решение, которое вы откладываете. Что мешает мозгу его принять?',
    fact: 'Среднее время формирования новой привычки — 66 дней, а не 21, как принято считать. Источник — исследование UCL, 2009.',
    factTag: 'Привычки',
    pre: 'До следующего урока: подумайте о коммуникации, где вас «не слышат». Чего там не хватает?',
  ...
  },
  {
    ...
    subtitle: 'Коммуникация на основе понимания когнитивных процессов',
    lecturer: 'Екатерина Ларина',
    duration: 18, xp: 70,
    task: 'Напишите одну фразу-«разморозку», которую попробуете в ближайшем разговоре.',
  ...
  },
  {
    ...
    lecturer: 'Александра Болдина',
    duration: 12, xp: 80,
    task: 'Сделайте дыхание 4-7-8 один раз и опишите одним словом, что почувствовали.',
